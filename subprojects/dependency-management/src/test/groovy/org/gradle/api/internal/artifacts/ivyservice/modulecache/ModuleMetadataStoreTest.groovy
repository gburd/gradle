...
class ModuleMetadataStoreTest extends Specification {
    ...
    def "putModuleDescriptor uses PathKeyFileStore to write file"() {
        ...
        def descriptor = new DefaultMutableMavenModuleResolveMetadata(Mock(ModuleVersionIdentifier), moduleComponentIdentifier, []).asImmutable(TestUtil.attributesFactory(), NamedObjectInstantiator.INSTANCE)
