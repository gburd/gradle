...
public abstract class ExternalDependencyDescriptor {
    ...
    public List<ConfigurationMetadata> getMetadataForConfigurations(ImmutableAttributes consumerAttributes, AttributesSchemaInternal consumerSchema, ComponentIdentifier fromComponent, ConfigurationMetadata fromConfiguration, ComponentResolveMetadata targetComponent) {
        if (useLegacyConfigurationSelection(consumerAttributes, consumerSchema, targetComponent)) {
    ...
    private boolean useLegacyConfigurationSelection(ImmutableAttributes consumerAttributes, AttributesSchemaInternal consumerSchema, ComponentResolveMetadata targetComponent) {
        if (targetComponent.getVariantsForGraphTraversal(consumerAttributes).isEmpty()) {
